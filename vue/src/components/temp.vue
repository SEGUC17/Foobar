...
<div class="bg-content">
 <div class="container">
    ...
    <input type="text" class="form-control"  placeholder="interest" v-model="val" >

    <center><button class="" v-on:click="ee">Get all announcements</button></center>
    <div>{{msg}}</div>
  </div>
  </div>
...
export default {
  ...
  methods: {
    ee: function () {
      this.$http.post('http://52.210.115.35:3000/admin/addInterest',{name:this.val}).then(response => {
