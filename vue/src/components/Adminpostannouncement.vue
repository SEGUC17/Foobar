...
methods:{
        ...
        {
            this.$http.post('http://54.77.11.251:3000/api/admins/announcements/post', {"title":this.title,"content":this.content}, {headers : {'jwt-token' : localStorage.getItem('id_token')}}).then(data => {
              swal(
          'Success',
          'Announcement posted',
          'success'
