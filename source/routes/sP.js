...
router.get('/', (req, res) => { // SP home page
  // res.render('index');
...
router.post('/upload', upload.single('avatar'), (req, res) => {
  ...
  image.save((err) => {
    if (err) { console.log('error'); } else { res.send("sucess"); }
    console.log('success');
  });
});
...
router.get('/videos/:id', sPController.getVideo); // adding an embedded video//adding an embedded video
