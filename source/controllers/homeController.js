...
const homeController = {
  //to redirect based on the account type
  findProfile(req, res) {
    ...
    // view service providers offers(if there are any offers matching the interests of the student these will be shown if not the last  10 offers will be shown)
    viewOffers(req, res) {
