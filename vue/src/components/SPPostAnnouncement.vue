...
methods:{
        ...
        {
            this.$http.post('http://52.210.115.35:3000/api/sPs/announcements/post', {"title":this.title,"content":this.content}, {headers : {'jwt-token' : localStorage.getItem('id_token')}}).then(data => {
